...
export default [
    ...
    },
    {
        ...
        subtitle: "Voluntary Work",
        img: "ilk-st-margaret.png",
        altText: "Screenshot of Village Website",
        skills: ["React", "React hooks", "responsive", "mobile-first", "HTML & CSS", "working to customer requirements"],
        linkText: "Click the link to see the site on Netlify",
        siteUrl: "https://roaring-cat-439b93.netlify.app/",
        gitHubRepoUrl: "https://github.com/FrancesHitchcock/ReactISM",
        description: (<><p>I built this website from scratch for a local village. The design includes specifications provided by the village Parish Meeting. The site was originally built using Vanilla JavaScript in 2022, with multiple HTML pages. One of the disadvantages of the traditional multi-page structure was the time and effort required to keep it up-to-date with current events, as it needs to be updated on a regular basis. So in May 2023 I rebuilt it using React, with all the data in separate data files. The new React version provides a more graceful user experience and should be easier to update.</p><p>The site is fully responsive, and is built mobile-first. The navigation elements on the mobile version are structured differently from those on the large screen version, including a hamburger and slide-in menu system for the smaller screens. The photo gallery on the Village Show page achieves responsiveness using flexbox.</p><p>The code for the animated hamburger menu and the &lt;Carousel /&gt; component have been adapted from examples provided online.</p><p>To see the live version on the World Wide Web visit <a href="http://www.ilketshall.org.uk/" target="_blank">http://www.ilketshall.org.uk/</a> or google "Ilketshall St Margaret".</p></>),
    },
]